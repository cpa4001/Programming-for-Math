...
You can find this tutorial at https://mosullivan.sdsu.edu/Teaching/sdsu-sage-tutorial/index.html </br>
...
**Week 12: Mathematical Structures - Fields and Coding Theory (4 Hours)** </br>
This module dives further into modern algebra and abstract algebra with fields which are abstract structures that can be created in sage specified at a certain root polynomial. In each of these fields, the operations of addition, subtraction, multiplication, and division are defined and behave similar to the same operations with rational and real numbers. Sage can be used to create finite fields, generate random polynomials, and give specifications of fields called embeddings in real or complex context. The next module, Coding Theory, introduces linear codes which are finite-dimensional vector spaces. These linear codes are difined as a matrix over a field which will create a vector space similar to the linear algebra module. Linear codes and fields, along with their ability to generate polynomials, have crucial applications in cryptography including error-correcting codes that allow for reliable transmission of information across noisy networks.
